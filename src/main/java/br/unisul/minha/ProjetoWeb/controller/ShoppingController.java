...
import br.unisul.minha.ProjetoWeb.model.ListShopDto;
...
public class ShoppingController {
	...
	public ResponseEntity newShopping(@RequestBody ListShopDto shopping, BindingResult result) {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("/");
...
//	@PostMapping(value = "/shopping")
//	public ModelAndView newShopping(@ModelAttribute("Shopping") ShoppingList form) {
//		ModelAndView mv = new ModelAndView();
//		mv.setViewName("/");
////        String validate = shoppingService.save(shoppings);
////        if(!validate.isEmpty()) {
